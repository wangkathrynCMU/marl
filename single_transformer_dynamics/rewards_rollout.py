...
if __name__ == '__main__':
    ...
    reward_model = RewardDynamicsModel(s_dim, a_dim, h_dim)
    ...
    for i in range(3):
        ...
        # print("predicted_reward_dynamics", predictedr[i])
        # print("predicted_reward_model", predictedr_model[i])
        plt.plot(x_axis, predictedr[i],'--',color=agent_colors[i], label = "predicted_reward agent " + str(i))
        plt.plot(x_axis, predictedr_model[i],'o',color=agent_colors[i], label = "predicted_reward_model agent " + str(i))
        plt.plot(x_axis, actualr[i], '-', color=agent_colors[i], label = "actual_reward agent " + str(i))
    plt.legend()
