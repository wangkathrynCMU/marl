...
class MultiAgentDynamicsModel(nn.Module):
    ...
    def get_loss(self,states,actions,next_states, rewards):
        ...
        print("next_state_reward", next_state_reward)
        print("next state reward shape:", next_state_reward.shape)
...
def gather_data(N,ep_len, env_name, env_config, trainer=None, noise = 0):
    ...
    for i in range(N):
        ...
        for j in range(ep_len):
            ...
            print("next_state", i, j, obs)
            print("reward", i, j, reward)
...
if __name__ == '__main__':
    ...
    batch_size = 2
    print("shape", states.shape, actions.shape, next_states.shape, rewards.shape)
